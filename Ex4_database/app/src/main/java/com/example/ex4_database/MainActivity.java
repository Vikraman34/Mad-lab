                ...
                insert.setOnClickListener(new View.OnClickListener() {
                  ...
                  public void onClick(View v) {
                      ...
                      if (TextUtils.isEmpty(name.getText())) {
                          ...
                          Toast.makeText(MainActivity.this, "Enter your salary ", Toast.LENGTH_SHORT).show();
                          ...
                          String department_value = department.getSelectedItem().toString();
                          String employee_code_value = employee_code.getText().toString();
                          String gender_value = ((RadioButton) findViewById(gender.getCheckedRadioButtonId())).getText().toString();
                          Double salary_value = Double.parseDouble(String.valueOf(salary.getText()));

                          Boolean checkInsertData = db.insertUserdata(employee_code_value, name_value, gender_value, department_value, salary_value);
            ...
            public void onClick(View v) {
                ...
                update.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Boolean checkUpdateData = db.updateUserdata(employee_code_value, name_value, salary_value);
                ...
                public void onClick(View v) {
                    ...
                    delete.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            Boolean checkDeleteData = db.deleteUserdata(employee_code_value);
            ...
            delete_all.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (checkDeleteData == true)
                        ...
                        Toast.makeText(MainActivity.this, "Table Not Deleted", Toast.LENGTH_SHORT).show();
                }
            });
